...
export default function SignRegister() {
  ...
  const [user, setUser] = useState("3128143575-member001");
  ...
  const empCode = "3128143575-member001";
      ...
      <div className="min-h-screen flex flex-col bg-gray-100" onContextMenu={windowRClick}>
        ...
        <div className="flex-1 flex">
          ...
          <main className="flex-1 p-4">
            ...
            <div className="mt-4">
              <button className="bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600 mr-[5px]" onClick={handleSubmit}>
                문서 만들기
              </button>
              <button className="bg-gray-500 text-white px-6 py-2 rounded hover:bg-gray-600 ml-[5px]" onClick={handleHome}>
                취소
              </button>
            </div>
          </main>

            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex-1 flex items-center">
                  <input className="w-3/5 border rounded px-2 py-1" name="comCode" value={formData.comCode} onChange={handleInputChange} />
                  <button
                    type="button"
              ...
              <div className="flex items-center space-x-2">
                ...
                <input className="w-1/2 border rounded px-2 py-1" name="comName" value={formData.comName} onChange={handleInputChange} readOnly />
              </div>

              {/* 대표 이름 */}
              <div className="flex items-center space-x-2">
                <label className="w-1/2">대표 이름</label>
                <input className="w-1/2 border rounded px-2 py-1" name="ceoName" value={formData.ceoName} onChange={handleInputChange} readOnly />
              </div>

              {/* 대표 연락처 */}
              <div className="flex items-center space-x-2">
                <label className="w-1/2">대표 연락처</label>
                <input className="w-1/2 border rounded px-2 py-1" name="ceoPhone" value={formData.ceoPhone} onChange={handleInputChange} readOnly />
              </div>

              {/* 담당자 연락처 */}
              <div className="flex items-center space-x-2">
                <label className="w-1/2">담당자 연락처</label>
                <input className="w-1/2 border rounded px-2 py-1" name="contectPhone" value={formData.contectPhone} onChange={handleInputChange} />
              </div>

              {/* 직원 수 */}
              <div className="flex items-center space-x-2">
                <label className="w-1/2">직원 수</label>
                <input className="w-1/2 border rounded px-2 py-1" name="empNum" value={formData.empNum} onChange={handleInputChange} />
              </div>
              ...
              <button type="submit" className="w-2/3 bg-orange-400 hover:bg-orange-600 text-white mt-6 py-2 rounded">
                신청하기
              </button>
            </form>
          </div>
      ...
      <div className="flex max-w-screen-lg mx-auto mt-10 p-6 bg-yellow-100 rounded-lg shadow-md relative">
        <div className="flex-1">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              <label className="w-1/2">회사 이름</label>
              <input className="w-1/2 border rounded px-2 py-1" value={comName} readOnly />
            </div>
            <div className="flex items-center space-x-2">
              <label className="w-1/2">대표 이름</label>
              <input className="w-1/2 border rounded px-2 py-1" value={ceoName} readOnly />
            </div>
            <div className="flex items-center space-x-2">
              <label className="w-1/2">대표 연락처</label>
              <input className="w-1/2 border rounded px-2 py-1" value={ceoPhone} readOnly />
            </div>
            <div className="flex items-center space-x-2">
              <label className="w-1/2">담당자 연락처</label>
              <input

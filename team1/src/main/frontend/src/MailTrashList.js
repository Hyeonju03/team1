        ...
        if (isLoggedIn && empCode) {
            const fetchData = async () => {
                try {
                    ...
                    //메일가져오기
                    const response2 = await axios.get('/selectDeleteList', {
                        params: {
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex-1 flex">
                ...
                <main className="ml-64 mt-14 flex-1 p-6 w-full h-full sm:w-[80%] md:w-[70%] lg:w-[60%]">
                    ...
                    <div className="text-2xl w-full font-bold mb-4 text-left">휴지통</div>
                    ...
                    <div className="flex bg-gray-200 p-3">
                        ...
                        <button onClick={deleteSelectedMails} className="flex items-center"
                                style={{marginLeft: "30px"}}>삭제
                        </button>
                        <button onClick={againMails} className="flex items-center"
                    ...
                    <div className="mb-20">
                        {(searchList ? serachResult : currentMails).length > 0 ? (
                            (searchList ? serachResult : currentMails).map((v, i) => (
                                <div className="flex border-b-2 items-center pt-2 pb-2 hover:bg-gray-50" key={i}>
                                    ...
                                    <div className="flex ml-5 w-[100%] justify-between">
                                        <p className="w-1/6 text-left overflow-hidden whitespace-nowrap text-ellipsis">{v.mailTarget}</p>
                                        <div className="flex items-center w-2/6 text-left min-w-[150px]">
                                            {v.fileName && (
                            ...
                            <p className="pt-3 pb-3 border-b-2">메일이 없습니다.</p>
                        )}

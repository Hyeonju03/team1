        ...
        if (isLoggedIn && empCode) {
            const fetchData = async () => {
                try {
                    ...
                    //메일가져오기
                    const response2 = await axios.get('/selectToMeSendMail', {
                        params: {
                            empCode: empCode, mailTarget: mailEmpCode // 필요한 파라미터
                        }
                    });
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex-1 flex">
                ...
                <main className="ml-64 mt-14 flex-1 p-6 w-full h-full sm:w-[80%] md:w-[70%] lg:w-[60%]">
                    ...
                    <div className="text-2xl w-full font-bold mb-4 text-left">내게쓴메일함</div>
